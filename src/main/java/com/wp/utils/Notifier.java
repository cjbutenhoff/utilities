...
/**
 * This class provides a generic notifier to record errors. At the moment we
 * record errors to New Relic. We may add other destinations in the future.
 *
...
public class Notifier {
    ...
    // private static final Logger rawlogger =
    // LoggerFactory.getLogger("exceptions-raw");
