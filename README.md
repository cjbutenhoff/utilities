A set of Java Utility classes for Servlet Filters (CORSFilter, Nile Logging Filter), and interactions with S3, Kafka, ElasticSearch, Flume, and Nile/Docker images.
